...
public class EditarJogadorView extends javax.swing.JFrame {

    private final EditarJogadorController controller;

    public EditarJogadorView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarJogadorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarJogadorView().setVisible(true);
            }
        });
    }
